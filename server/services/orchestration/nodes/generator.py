...
# 🚨 UPDATE: Enable streaming and add a unique tag to isolate this LLM's token stream
llm = ChatOpenAI(
    ...
    temperature=0.1,
    streaming=True 
).with_config({"tags": ["final_generator"]})
...
"""
    ...
    # 6. Generate Response (Streams automatically due to astream_events in router)
